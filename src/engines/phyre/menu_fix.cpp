...
#include "../../core/game.h"
#include "../../core/log.h"
#include "../../core/mem.h"   // readableRange + tryRead (guarded game-memory reads)
#include "../../core/hook_util.h"   // Game, atlas/build enums, matches, installMinHookDetour
...
void detectAndInstallGameHooks() {
  ...
  for (const auto& game : games) {
    ...
    atfix::installBattleTransitionFix(gameBase, game);
