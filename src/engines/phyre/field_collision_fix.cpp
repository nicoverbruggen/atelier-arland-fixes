...
//
// The two field-collision corrections. What they fix, and why each takes the
// shape it does, is in field_collision_fix.h. What is here is the per-build
// wiring and the notes that only mean anything beside the code they sit on.
